        ...
        <>
            ...
            <div className={`${style.card} flex flex-row gap-28 ${props.className || ""}`}>
                ...
                <div className={`flex flex-col justify-start items-start gap-20 ${style.info}`}>
                    ...
                    <h2>{title}</h2>
                    <p className={style.text}>{description} <br /> {extra}</p>
                        ...
                        {video &&
                            <button onClick={() => setVideoVisible(true)}>
                                <svg className="icon" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.75 13.75H36.25M7.5 6.25H32.5C34.575 6.25 36.25 7.925 36.25 10V32.5C36.25 34.575 34.575 36.25 32.5 36.25H7.5C6.50544 36.25 5.55161 35.8549 4.84835 35.1517C4.14509 34.4484 3.75 33.4946 3.75 32.5V10C3.75 7.925 5.425 6.25 7.5 6.25Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M8.75 13.75L13.75 6.25M17.5 13.75L22.5 6.25M26.25 13.75L31.25 6.25M16.25 20V30L26.25 25L16.25 20Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
